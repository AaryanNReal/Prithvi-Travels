// app/tours/international/InternationalToursClient.tsx
'use client';
...
export default function InternationalToursClient() {
  ...
  if (error) {
    return (
      <div className="container mx-auto py-12 px-4 text-center">
        <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Domestic Tours</h1>
    ...
    <div className="container mx-auto py-12 mt-15 px-4">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-8 gap-4">
        <div className="order-1 md:order-none">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2">Domestic Tours</h1>
          ...
          {filteredTours.length > 0 ? (
            ...
            <div className="text-center py-12">
              <h2 className="text-2xl font-medium text-gray-700">
                {searchTerm ? 'No tours match your search' : 'No international tours available at the moment'}
              </h2>
              {searchTerm ? (
                <button
