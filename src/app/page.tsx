...
const BackgroundElements = () => (
  <div className="fixed inset-0 pointer-events-none overflow-hidden -z-10">
    ...
    <div className="absolute top-40 right-20 w-16 h-16 bg-purple-200 rounded-full opacity-25 animate-float" 
         style={{ animationDuration: '8s', animationDelay: '1s' }} />
    <div className="absolute bottom-40 left-1/4 w-12 h-12 bg-teal-200 rounded-full opacity-30 animate-float" 
         style={{ animationDuration: '7s', animationDelay: '2s' }} />
    <div className="absolute top-1/3 right-1/3 w-24 h-24 bg-yellow-200 rounded-full opacity-15 animate-float" 
         style={{ animationDuration: '9s', animationDelay: '3s' }} />
    
    {/* Animated Particles */}
    <div className="absolute top-1/4 left-1/2 w-2 h-2 bg-blue-400 rounded-full opacity-40 animate-pulse" 
         style={{ animationDuration: '3s' }} />
    <div className="absolute top-3/4 right-1/4 w-3 h-3 bg-purple-400 rounded-full opacity-30 animate-pulse" 
         style={{ animationDuration: '4s', animationDelay: '1.5s' }} />
    <div className="absolute bottom-1/4 left-1/3 w-2 h-2 bg-teal-400 rounded-full opacity-50 animate-pulse" 
