// app/tours/special-offers/SpecialOffersClient.tsx
'use client';
    ...
    <div className="container mx-auto py-12 mt-15 px-4">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-6">
        <div className="flex-1">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Grab the Offer While It Lasts!</h1>
          <p className="text-xl text-gray-600 max-w-3xl">
            Don't just take our word for it - hear from our globetrotters about their unforgettable journeys crafted by our expert team.
          </p>
        </div>
          ...
          {filteredTours.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredTours.map(tour => (
                <TourCard
                  ...
                  imageURL={tour.imageURL || "/images/default-tour.jpg"}
            ...
            <div className="text-center py-12">
              <h2 className="text-2xl font-medium text-gray-700">
                {searchTerm ? 'No offers match your search' : 'No special offers available at the moment'}
              </h2>
              {searchTerm ? (
                <button
