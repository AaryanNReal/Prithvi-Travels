...
export default function FeaturedDomesticTours() {
    ...
    const fetchFeaturedDomesticTours = async () => {
      try {
        ...
        const toursData = querySnapshot.docs.map(doc => ({
          id: doc.id,
          ...doc.data(),
          itenaries: doc.data().itenaries || {} // Ensure itineraries exists
        })) as Tour[];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const tourDetails = selectedTour ? {
        ...
        itenaries: selectedTour.itenaries || {} // Include complete itineraries
      } : null;
  ...
  return (
    <>
      ...
      <main className="container mt-3 mx-auto px-4">
