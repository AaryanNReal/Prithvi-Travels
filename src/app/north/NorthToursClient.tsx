// app/tours/domestic/north/NorthToursClient.tsx
'use client';
...
export default function NorthToursClient() {
          ...
          {filteredTours.length > 0 ? (
            ...
            <div className="text-center py-12">
              <h2 className="text-2xl font-medium text-gray-700">
                {searchTerm ? 'No tours match your search' : 'No Northern India tours available at the moment'}
              </h2>
              {searchTerm ? (
                <button
